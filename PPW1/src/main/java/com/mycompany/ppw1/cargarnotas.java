 ...
 * @author marie
 */
public class cargarnotas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PreparedStatement comando = conexion.prepareStatement("SELECT * FROM t_nota WHERE fk_autor = ? AND activa = 1 ORDER BY fecha_Creacion DESC LIMIT ?, 10");
