...
public class actualizarNota extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String idS = request.getParameter("idnota");
            ...
            PreparedStatement comando = conexion.prepareStatement("UPDATE t_nota SET texto = ?, etiqueta = ? WHERE id = ?");
            comando.setString(1, request.getParameter("textarea"));
            comando.setString(2, request.getParameter("etiquetas"));
            comando.setInt(3, idI);
            comando.execute();
