...
public class crearNota extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PreparedStatement comando = conexion.prepareStatement("INSERT INTO t_nota(texto, fk_autor, etiqueta) VALUES ( ?, ?, ?)");
            comando.setString(1, request.getParameter("textarea"));
            comando.setInt(2, idU);
            comando.setString(3, request.getParameter("etiqueta"));
